...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*database*/ 1 && t_value !== (t_value = /*option*/ ctx[7].view + "")) set_data_dev(t, t_value);

    			if (dirty & /*database*/ 1 && option_value_value !== (option_value_value = /*option*/ ctx[7].value)) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*orm*/ 2 && t_value !== (t_value = /*option*/ ctx[7].view + "")) set_data_dev(t, t_value);

    			if (dirty & /*orm*/ 2 && option_value_value !== (option_value_value = /*option*/ ctx[7].value)) {
    				prop_dev(option, "__value", option_value_value);
    				option.value = option.__value;
    			}
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			select_option(select0, /*selectedDatabase*/ ctx[2]);
    			append_dev(div0, t1);
    			append_dev(div0, br0);
    			append_dev(div0, t2);
    			...
    			select_option(select1, /*selectedOrm*/ ctx[3]);
    			append_dev(div1, br1);
    			append_dev(div1, t4);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let selectedOrm = "";
    	const writable_props = ["name", "database", "orm"];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("database" in $$props) $$invalidate(0, database = $$props.database);
    		if ("orm" in $$props) $$invalidate(1, orm = $$props.orm);
    		if ("selectedDatabase" in $$props) $$invalidate(2, selectedDatabase = $$props.selectedDatabase);
    		if ("selectedOrm" in $$props) $$invalidate(3, selectedOrm = $$props.selectedOrm);
    	};
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { name: 4, database: 0, orm: 1 });
